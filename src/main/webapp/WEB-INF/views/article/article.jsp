                ...
                <div class="row">
                    <div class="col-xl-12">
                        <ol class="list-inline">
                           <li class="list-inline-item"><a href="<c:url value="/article/nouveau"/>"><i class="fa fa-plus">&nbsp;<fmt:message code="common.ajouter"/></i></a></li>
                            ...
                            <table width="100%" class="table table-striped table-bordered table-hover"
                                ...
                                <tr>
                                    ...
                                    <th><fmt:message code="article.prix.unitaire.ttc"/></th>
                                     <th><fmt:message code="article.taux.tva"/></th>
