                ...
                <div class="row">
                    <div class="col-xl-12">
                        <ol class="list-inline">
                           <li class="list-inline-item"><a href="<c:url value="/category/nouveau"/>"><i class="fa fa-plus">&nbsp;<fmt:message code="common.ajouter"/></i></a></li>
                    ...
                    <div class="card card-primary">
                        ...
                        <div class="card-body">
                            <table width="100%" class="table table-striped table-bordered table-hover"
                                ...
                                <thead>
                                <tr>
                                    <th><fmt:message code="category.code"/></th>
                                    <th><fmt:message code="category.designation"/></th>
                                ...
                                <tbody>
                                    <c:forEach items="${categories }" var="category">
                                        <tr class="odd gradeX">
                                           ...
                                           <td>
                                               <c:url value="/category/modifier/${category.getIdCategory() }" var="urlModif" />
                                               <a href="${urlModif }"><i class="fa fa-edit"></i></a>
                                               &nbsp;|&nbsp;
                                               <a href="javascript:void(0);" data-toggle="modal" data-target="#modalClient${category.getIdCategory()}"><i class="fa fa-trash-o"></i></a>
                                               &nbsp;|&nbsp;
                                               <div class="modal fade" id="modalClient${category.getIdCategory() }" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
