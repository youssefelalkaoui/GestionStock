     ...
     <%@ include file="/WEB-INF/views/menu_left/leftMenu.jsp" %>
        ...
        <div id="page-wrapper" class="p-4">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-xl-12">
                        <h1 class="page-header"><fmt:message code="common.vente"/></h1>
                    </div>
                    <!-- /.col-xl-12 -->
                </div>
                <div class="row">
                    <div class="col-xl-12">
                        <ol class="list-inline">
                           <li class="list-inline-item"><a href="<c:url value="/vente/nouveau"/>"><i class="fa fa-plus">&nbsp;<fmt:message code="common.ajouter"/></i></a></li>
                    ...
                    <div class="card card-primary">
                        ...
                        <div class="card-body">
                            <table width="100%" class="table table-striped table-bordered table-hover"
                                ...
                                <thead>
                                <tr>
                                    <th><fmt:message code="vente.code"/></th>
                                    <th><fmt:message code="vente.date"/></th>
                                ...
                                <tbody>
                                    <c:forEach items="${ventes }" var="vente">
                                        <tr class="odd gradeX">
                                           ...
                                           <td>
                                               <c:url value="/vente/modifier/${vente.getIdVente() }" var="urlModif" />
                                               <a href="${urlModif }"><i class="fa fa-edit"></i></a>
                                               &nbsp;|&nbsp;
                                               <a href="javascript:void(0);" data-toggle="modal" data-target="#modalClient${vente.getIdVente()}"><i class="fa fa-trash-o"></i></a>
                                               &nbsp;|&nbsp;
                                               <div class="modal fade" id="modalClient${vente.getIdVente() }" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                               ...
                                               <div class="modal-body">
                                                   <fmt:message code="vente.confirm.suppression.msg"/>
                                               </div>
                                        <div class="modal-footer">
                                            <button type="button" class="btn btn-secondary" data-dismiss="modal"><fmt:message code="common.annuler"/></button>
                                            <c:url value="/vente/supprimer/${vente.getIdVente() }" var="urlSuppression" />
