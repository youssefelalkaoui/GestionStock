     ...
     <%@ include file="/WEB-INF/views/menu_left/leftMenu.jsp" %>
        ...
        <div id="page-wrapper" class="p-4">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-xl-12">
                        <h1 class="page-header"><fmt:message code="common.parametrage.utilisateur"/></h1>
                    </div>
                    <!-- /.col-xl-12 -->
                </div>
                <div class="row">
                    <div class="col-xl-12">
                        <ol class="list-inline">
                           <li class="list-inline-item"><a href="<c:url value="/utilisateur/nouveau"/>"><i class="fa fa-plus">&nbsp;<fmt:message code="common.ajouter"/></i></a></li>
                                ...
                                <tbody>
                                    <c:forEach items="${utilisateurs }" var="utilisateur">
                                        <tr class="odd gradeX">
                                           ...
                                           <td>
                                               <c:url value="/utilisateur/modifier/${utilisateur.getIdUtilisateur() }" var="urlModif" />
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <c:url value="/utilisateur/supprimer/${utilisateur.getIdUtilisateur() }" var="urlSuppression" />
